...
// Hash claim value with salt using SHA-256
function hashClaimWithSalt(claimValue, salt) {
  const combined = Buffer.concat([salt, Buffer.from(claimValue, 'utf8')]);
...
// Compute root hash from all claim hashes + root salt
