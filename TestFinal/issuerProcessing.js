...
//verifierDID = 'did:ethr:0x3f5CE5FBFe3E9af3971dD833D26BA9b5C936f0bE';
...
function processClaimsWithMetrics(claims) {
  ...
  // Also compute average claim size bytes (UTF-8)
...
function main() {
  ...
  // You can loop through credential types here or set manually
  ...
  for (const credentialType of credentialTypes) {
    try {
      ...
      console.log(`Average claim size (averaged over ${NUM_ITERATIONS} runs): ${output.averageClaimSizeBytes} bytes`);
